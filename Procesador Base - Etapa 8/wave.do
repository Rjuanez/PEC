...
add wave -noupdate -expand -group TLB_INS /test_sisa/SoC/proc0/d0/tlb_ins/addr_in
add wave -noupdate -expand -group TLB_INS /test_sisa/SoC/proc0/d0/tlb_ins/addr_out
add wave -noupdate -expand -group TLB_INS /test_sisa/SoC/proc0/d0/tlb_ins/miss_tlb
add wave -noupdate -expand -group TLB_INS -expand /test_sisa/SoC/proc0/d0/tlb_ins/registro_tlb
add wave -noupdate -expand -group TLB_INS /test_sisa/SoC/proc0/d0/tlb_ins/entrada
...
add wave -noupdate -group Datapath /test_sisa/SoC/proc0/d0/aTOx
add wave -noupdate -group Datapath -radix hexadecimal /test_sisa/SoC/proc0/d0/addr_b
add wave -noupdate -group Datapath /test_sisa/SoC/proc0/d0/bTO
add wave -noupdate -group Datapath /test_sisa/SoC/proc0/d0/addr_d
...
WaveRestoreCursors {{Ins desalineada} {390000 ps} 0} {{Div ins error} {1826569 ps} 0} {{St desalineado} {4559690 ps} 0} {{Cursor 4} {7742744 ps} 0} {AQUII {3107890 ps} 0}
...
update
WaveRestoreZoom {7019151 ps} {9644687 ps}
